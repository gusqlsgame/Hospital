...
<%=pagePerBlock%>
	* (value - 1) + 1;
	...
	function read(idx) {
		...
		document.readFrm.pagefile.value = "./board/read";
...
<body>
 ...
 %> <a href="javascript:read('<%=idx%>')"><%=title%></a>
	...
	%><input type="button" onClick="javascript:location.href='main.jsp?pagefile=./board/post'" value="글쓰기">
	<%
		}
	%>
 ...
 %></a></li>
	...
	<form name="searchFrm" method="post"
		action="main.jsp?pagefile=./board/list">
