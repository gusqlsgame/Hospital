...
<body>
 ...
 %>
	...
	<hr />
	<input type="button" onClick="location.href = 'http://localhost:8080/Chapter12/main.jsp?pagefile=./board/list'" value="리스트">
	<%
	...
	%><input type="button" onClick="javascript:update('<%=idx%>')" value="수정">
	<%
		}
	%>
	<%
	...
	%><input type="button" onClick="javascript:reply('<%=idx%>')" value="답변">
	<%
		}
	%>
	<%
